...
function Dropzone({files, setFiles, displayFiles, setDispalyFiles}) {
...
const removeRejected = (name) => {
    setRejected(rejected => rejected.filter(({file})=> file.name ? file.name : file.original_filename !== name))
}
